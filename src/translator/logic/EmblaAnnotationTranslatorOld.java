 ...
 * @author wei wang
 */
public class EmblaAnnotationTranslatorOld implements AnnotationTranslator {
	...
	public Document xmlRoot = new DocumentImpl();; // xml root
	 ...
	 * Default constructor
	 */
	public EmblaAnnotationTranslatorOld() {
		super();
	}
	...
	/* (non-Javadoc)
	 * @see translator.logic.AnnotationTranslator#write2JSON(java.lang.String)
	 */
